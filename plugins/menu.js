 ...
 *Powered By @${'6282161152073'.split('@')[0]}*`
 ...
 const ftroli = {
    ...
    status: 1,
    surface : 1,
    message: `Dani-Bot-MD么 By Maulana`, 
    orderTitle: `▮Menu ▸`,
    thumbnail: await (await fetch('https://telegra.ph/file/f32f779ce8eaf70158228.jpg')).buffer(), //Gambarnye
    sellerJid: '0@s.whatsapp.net' 
    }
...
Saya Adalah _*BOT OFFICIAL*_ Salah Satu Bot Whatsapp Yang Siap Membantu Kamu Mempermudah Sesuatu Seperti Membuat Sticker Dan Lainnya, Kalo Kamu Mau Request Fitur Silahkan Ketik #request Pesan Atau Fitur Yang Kamu Inginkan!`
...
                 .replace(/%islimit/g, menu.limit ? 'Ⓛ' : '')
 ...
         externalAdReply: { 
             title: 'Dani-Bot-MD Testing Project By Maulana', 
